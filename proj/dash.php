...
if(@$_GET['q']== 2)
{
$q=mysqli_query($con,"SELECT * FROM ranking  ORDER BY score DESC " )or die('Error223a');
...
while($row = mysqli_fetch_array($result)) {
	...
	<td><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a>

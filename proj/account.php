...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="row header">
      <div class="col-md-6 box">
        <button type="button" class="btn btn-success"><a href="#" data-toggle="modal" data-target="#EDIT">edit</a></button>
      </div>
    </div>
     <form class="navbar-form navbar-left" role="search" method="post">
      <div class="form-group">
     <input type="text" name='search' class="form-control" placeholder="Enter tag ">
        </div>
        <button type="submit"  name="submit"class="btn btn-default"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;Search</button>
  ...
  $str = $_POST["search"];
  $result = mysqli_query($con,"(select * from quiz where tag = '$str')");
...
<div class="modal fade" id="EDIT" >
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <h4 class="modal-title"><span style="color:orange;font-family:'typo' ">UPDATE INFO</span></h4>
      </div>
      <div class="modal-body title1">
      <div class="row">
      <div class="col-md-3"></div>
      <div class="col-md-6">
      <form role="form" method="post" action=updation.php>
      <div class="form-group">
        <input type="text" name="phone" maxlength="15" placeholder=" new Phone  " class="form-control"/>
      </div>
...
echo'<br /><button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;lock and next</button></form></div>';
